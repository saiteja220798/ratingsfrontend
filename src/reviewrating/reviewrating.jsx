...
export function ReviewRatings() {
    ...
    const fetchReviews = async () => {
        try {
            const response = await axios.get(`http://localhost:8000/get-ratings-reviews?hotelname=${hotelname}`);
    ...
    const handleEditReview = (reviewId, existingRating, existingReview) => {
        // Remove the check for user review
    ...
    const handleDeleteReview = async (reviewId) => {
        ...
        try {
            ...
            await axios.delete(`http://localhost:8000/delete-rating-review/${reviewId}`, config);
